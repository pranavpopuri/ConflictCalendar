...
import { SpinUpStatus } from './components/SpinUpStatus';
import { useAuthStoreWithSpinUp } from './store/authWithSpinUp';

const AppWithSpinUpHandling = () => {
  const {
    isAuthenticated,
    checkAuth,
    isSpinningUp,
  ...
  return (
    <Router>
      {/* Spin-up status notification */}
      <SpinUpStatus
        isSpinningUp={isSpinningUp}
        attempt={retryAttempt}
        onDismiss={() => setSpinUpState(false)}
      />
...
export default AppWithSpinUpHandling;
